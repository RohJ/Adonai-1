...
<body>
  ...
  -->
      <div class="logo">
        <a href="http://localhost:8080" class="simple-text logo-mini">
          Adonai Church
        </a>
        <a href="javascript:;" onclick="document.forms['logoutForm'].submit()" class="simple-text" style="font-size: 10px;">
          Logout
        </a>
      </div>
